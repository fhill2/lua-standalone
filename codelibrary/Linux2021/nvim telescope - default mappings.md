...
https://github.com/nvim-telescope/telescope.nvim#mappings
...
mappings.default_mappings = config.values.default_mappings or {
	...
	actions.run_builtin = gets selected entry as string, if string contains : then reuqire builtin and run it
